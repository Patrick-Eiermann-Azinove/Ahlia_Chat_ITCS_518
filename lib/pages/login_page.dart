...
import 'package:ahlia_chat/providers/auth_provider.dart';
                ...
                style: ButtonStyle(
                  backgroundColor: MaterialStateProperty.resolveWith<Color>(
                    (Set<MaterialState> states) {
                      if (states.contains(MaterialState.pressed)) return Color(0xffba160c).withOpacity(0.8);
                      return Color(0xffba160c);
                    },
                  ),
